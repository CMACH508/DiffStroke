...
parser.add_argument(
        ...
        type=str,
        default=None,
        help="path to the natural-image DiffStroke checkpoint used to initialize face fine-tuning",
)
parser.add_argument(
        "--landmark_model",
        type=str,
        default=None,
        help="path to dlib 68-point landmark predictor",
)
parser.add_argument(
        "--config",
        type=str,
...
opt = resolve_common_paths(
    opt,
    dataset_parts=["CelebA-HQ"],
    legacy_dataset="./Dataset/CelebA-HQ",
    init_fusion_parts=["diffstroke", "natural", "model_fusion_170000.pth"],
    legacy_init_fusion="./experiments/MaskV2/models/model_fusion_170000.pth",
    need_landmark=True,
)
...
if __name__ == '__main__':
    ...
    ckp_fn = torch.load(opt.init_fusion_ckpt, map_location='cpu')
